        ...
        <div class="hl_page-creator--column">
          ...
          <div class="hl_page-creator--element">
            ...
            <span class="add-new-element" data-tooltip="tooltip" data-placement="bottom" title="Add New Element"><i
                class="icon icon-plus"></i></span>
            <div class="element-container">
              <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Possimus sint at cum ratione, itaque
                quas assumenda consequatur, exercitationem ipsa necessitatibus, eaque nemo aliquid quasi.
                Doloremque dolor pariatur ea quod distinctio?</p>
            </div>
          </div>
        </div>
        <div class="hl_page-creator--column">
